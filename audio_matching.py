...
for i, query in enumerate(query_list):
    ...
    for j, db_chroma in enumerate(data_list):
        ...
        downsample_db_chroma = smoothing_downsampling(db_chroma, filter_length=41, downsampling_factor=20)
        print(downsample_db_chroma.shape)
...
print('target score:', target_score, score_list[target_ind], data.midi_file_name[target_ind])
